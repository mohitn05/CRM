...
import { ArrowLeft, BookOpen, Building2, Eye, EyeOff, Lock, Shield, User } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="bg-white/40 backdrop-blur-2xl border border-white/30 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-blue-50/50 border border-blue-200 rounded-xl p-4">
                ...
                <p className="text-blue-700 text-sm">
                  This portal provides tools to manage student applications, track progress,
                  and facilitate learning outcomes for your internship program.
                </p>
              </div>
